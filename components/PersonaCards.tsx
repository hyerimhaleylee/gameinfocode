...
const PERSONAS = [
  ...
  },
  {
    ...
    desc: "승률 8% 이상, 평균 생존 17분 이상, KD 1.0 이상. 싸움 없이 끝까지 살아남는 자기장의 달인.",
  ...
  },
  {
    ...
    desc: "KD 1.2 이상, 평균 딜량 160 이상, 근거리 교전 선호. 생각보다 총이 먼저 나간다.",
  ...
  },
  {
    ...
    desc: "게임당 도보 이동거리 2800m 이상, 주행거리 800m 미만. 두 발로 전장을 누빈다.",
  ...
  },
  {
    ...
    desc: "도보 이동거리 3500m 이상, KD 1.0 미만. 싸움은 못 하지만 달리기는 남다르다.",
