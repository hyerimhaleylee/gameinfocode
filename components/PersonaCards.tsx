...
const PERSONAS = [
  ...
  },
  {
    ...
    desc: "KD 2.0 이상에 헤드샷 28% 이상이지만 승률은 5% 미만. 에임은 타고났지만 판단력은 개발 중.",
  ...
  },
  {
    ...
    desc: "헤드샷 비율 32% 이상, KD 1.8 이상. 스코프 안에 들어오면 이미 게임 오버.",
    comment: "보이면 죽는다",
    color: "blue" as const,
  ...
  },
  {
    ...
    desc: "게임당 부활 0.8회 이상, 어시스트 1회 이상. 쓰러진 팀원을 살리는 것이 전문.",
  ...
  },
  {
    ...
    desc: "KD 1.5 이상, 평균 생존 15분 미만, 평균 딜량 220 이상. 처음 접선에서 결판을 낸다.",
  ...
  },
  {
    ...
    desc: "KDA 3.0 이상, 어시스트 1.5회 이상, KD 1.2 이상. 팀 전체를 읽는 게임 IQ의 소유자.",
  ...
  },
  {
    ...
    desc: "TOP 10 진입률 38% 이상이지만 KD 1.0 미만, 평딜 130 미만. 싸움보다는 생존이 목표.",
  ...
  },
  {
    ...
    desc: "부활 빈도 낮고, KD 1.2 이상, 승률 3% 이상. 팀원 걱정보다 내 생존이 우선.",
